...
add_action( 'tgmpa_register', 'ptt_register_required_plugins' );
/**
...
function ptt_register_required_plugins() {
	 ...
	 */
	$config = array(
		'id'           => 'premise_time_track',                 // Unique ID for hashing notices for multiple instances of TGMPA.
		'default_path' => '',                       // Default absolute path to bundled plugins.
		'menu'         => 'ptt-install-plugins', // Menu slug.
